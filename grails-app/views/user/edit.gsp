	...
	<s2ui:tab name='userinfo' height='275'>
		...
		<tbody>
			...
			<s2ui:textFieldRow name='username' labelCode='user.username.label' bean="${user}"
                            labelCodeDefault='Login' value="${user?.username}"/>
                            
            <s2ui:textFieldRow name='callsign' labelCode='user.callsign.label' bean="${user}"
                            labelCodeDefault='Callsign' value="${user?.callsign}"/>
